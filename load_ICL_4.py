...
for depth in depth_list:
    ...
    min_max = np.array([depth_image.min() / 5000, depth_image.max() / 5000]) #m -> pixel
...
txt = np.savetxt('./data/nerf_llff_data/ICL_NUIM2/poses_bounds_4.txt', npy_file)

npy = np.loadtxt('./data/nerf_llff_data/ICL_NUIM2/poses_bounds_4.txt', txt)
